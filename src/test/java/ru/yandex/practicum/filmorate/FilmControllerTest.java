...
public class FilmControllerTest {
    ...
    public void postRequestTest() {
        film.setName("Film");
        film.setDescription("Gde_email@");
        film.setDuration(Duration.ofMinutes(120));
        film.setReleaseDate(LocalDateTime.of(2002, 2, 2, 2, 2));
    ...
    public void createFilmsDescriptionLengthTest() {
        ...
        film1.setReleaseDate(LocalDateTime.of(2012, 2, 2, 2, 2));
    ...
    public void createIncorrectFilmsReleaseDateTest() {
        ...
        film1.setDuration(Duration.ofMinutes(150));
        film1.setReleaseDate(LocalDateTime.of(1800, 2, 2, 2, 2));
        exception = Assertions.assertThrows(ValidationException.class, () -> controller.createFilm(film1));
    ...
    public void createNegativeDurationOfFilm() {
        ...
        film1.setDuration(Duration.ofMinutes(-110));
        film1.setReleaseDate(LocalDateTime.of(2015, 2, 2, 2, 2));
        exception = Assertions.assertThrows(ValidationException.class, () -> controller.createFilm(film1));
